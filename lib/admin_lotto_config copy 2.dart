...
class _AdminLottoConfigState extends State<AdminLottoConfig> {
  ...
  // --- ฟังก์ชันอัปโหลดรูปภาพ (คงเดิมเพื่อความเสถียร) ---
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  // ✅ แสดงเวลาเปิด-ปิดในหน้าลิสต์
                  subtitle: Text(
                    "ปิดรับ: ${data['closeTime'] ?? '15:30'} | จ่าย 3 ตัว: x${data['digit3']}",
                  ),
